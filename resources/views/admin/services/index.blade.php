...
<div class="card">
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <form action="{{ route('admin.services.index') }}" method="GET" class="d-flex justify-content-end">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="checkbox" class="form-check-input check-item" value="{{ $service->id }}"></td>
                        <td>{{ $service->order }}</td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-sm btn-outline-danger" onclick="confirmDelete('{{ route('admin.services.destroy', $service) }}')">
    ...
    function confirmBulkDelete() {
        showConfirm({
            ...
            callback: function() {
                ...
                $.ajax({
                    url: '{{ route('admin.services.bulk_destroy') }}',
                    type: 'DELETE',
    ...
    function confirmBulkStatus(status) {
        ...
        showConfirm({
            ...
            callback: function() {
                const ids = Array.from(document.querySelectorAll('.check-item:checked')).map(cb => cb.value);
                $.ajax({
                    url: '{{ route('admin.services.bulk_status') }}',
                    type: 'POST',
