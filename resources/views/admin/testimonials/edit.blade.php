                ...
                <div class="col-md-12">
                        ...
                        <div class="mt-2" id="imagePreview">
                            ...
                            <div class="mt-2">
                                <div class="d-inline-block text-center" id="currentImageContainer">
                                    <img src="{{ asset('storage/' . $testimonial->image) }}" class="img-fluid rounded d-block mb-2" style="max-height: 100px;">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" {{ $testimonial->is_active ? 'checked' : '' }}>
