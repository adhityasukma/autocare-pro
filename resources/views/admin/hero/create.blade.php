    ...
    <div class="card-body">
        <form id="heroForm" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g. Premium Automotive Services" required>
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label">Subtitle</label>
                        <input type="text" name="subtitle" class="form-control" placeholder="e.g. Your trusted partner for all vehicle needs">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="button_text" class="form-control" placeholder="e.g. Explore Services">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Save Slide</button>
...
<script>
    ...
    $('#heroForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            error: function(xhr) {
                btn.prop('disabled', false).html('<i class="bi bi-check-lg"></i> Save Slide');
                const errors = xhr.responseJSON?.errors;
                if (errors) showMessage(Object.values(errors)[0][0], 'error');
                else showMessage('An error occurred during save.', 'error');
            }
        });
    });
</script>
